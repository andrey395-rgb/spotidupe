...
import 'package:spotidupe/common/widgets/favorite_button/favorite_button.dart';
...
import 'package:spotidupe/presentation/song_player/bloc/song_player_cubit.dart';
import 'package:spotidupe/presentation/song_player/bloc/song_player_state.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: BlocProvider(
        ...
        // 'https://firebasestorage.googleapis.com/v0/b/spotidupe1.appspot.com/o/songs%2FBathroom.mp3?alt=media'),
      ...
      builder: (context, state) {
        ...
        if (state is SongPlayerLoaded) {
          return Column(
            children: [
              Slider(
                  activeColor: const Color.fromARGB(255, 213, 213, 213),
